...
20.02.2019 v1
20.02.2019 v2 Количество свободной памяти
\*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*******************************************************************\
...
//  Скетч использует 14324 байт (99%) памяти устройства.
//  Глобальные переменные используют 475 байт (46%) динамической памяти,
//  оставляя 549 байт для локальных переменных.
//
#include <SimpleDHT.h>
//#include <SPI.h>
#include <Ethernet2.h>
